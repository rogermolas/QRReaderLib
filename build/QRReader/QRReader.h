...
/*!
 ...
 @abstract
    QRReader is an abstract based class that defines an interface for reading QR code.
 
 @discussion
    It is layered on the top of AVMetadataObject and it provides an interface for reading metadata.
   
    It use the "AVMetadataObjectTypeQRCode" type from AVMetadataObject.
